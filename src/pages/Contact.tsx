            ...
            {[
              {
                ...
                contact: "hello@privacythink.com",
                href: "mailto:hello@privacythink.com",
              },
              {
                icon: Bug,
                title: "Technical Support",
                description: "Experiencing issues? We're here to help.",
                contact: "support@privacythink.com",
              ...
              },
              {
                ...
                contact: "feedback@privacythink.com",
                href: "mailto:feedback@privacythink.com",
              },
            ].map((method, i) => (
              <motion.div
                key={i}
